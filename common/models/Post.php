...
class Post extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['title', 'content', 'status', 'author_id', 'category'], 'required'],
            [['content', 'tags'], 'string'],
            [['status', 'create_time', 'update_time', 'author_id', 'category'], 'integer'],
    ...
    public function afterSave($insert, $changedAttributes)
    {
        ...
        Category::updateCount($this->_oldCategory, $this->category);
    }
    ...
    public function afterDelete()
    {
        ...
        Category::updateCount($this->category, -1);
    }
